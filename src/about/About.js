...
function About(){
    ...
    return(
        ...
        active ? 
            ...
            <button className={styles.closeWindowButton} onClick={()=>{setActive(false);}}>
                X
            </button>
            <br/>
            ...
            <li>The next player must play on the board that matches the position of the square the previous player filled.</li>
            <li>If the next board is finished, the player can choose any available board to play on.</li>
            <li>Once all boards are finished, the player with the most wins is the total winner, or it's a draw if both players have the same number of wins.</li>
